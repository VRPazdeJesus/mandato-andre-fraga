...
/* harmony import */ var ngx_mask_ionic__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-mask-ionic */ "64T9");
...
const routes = [
    ...
    {
        path: 'nosso-mandato',
        loadChildren: () => Promise.all(/*! import() | nosso-mandato-nosso-mandato-module */[__webpack_require__.e("common"), __webpack_require__.e("nosso-mandato-nosso-mandato-module")]).then(__webpack_require__.bind(null, /*! ./nosso-mandato/nosso-mandato.module */ "m/sT")).then(m => m.NossoMandatoPageModule)
    },
    {
        path: 'projeto-de-lei',
    ...
    {
        path: 'colabore',
        loadChildren: () => Promise.all(/*! import() | colabore-colabore-module */[__webpack_require__.e("common"), __webpack_require__.e("colabore-colabore-module")]).then(__webpack_require__.bind(null, /*! ./colabore/colabore.module */ "j49U")).then(m => m.ColaborePageModule)
    },
    {
        path: 'contato',
    ...
    {
        path: 'recupera-senha',
        loadChildren: () => Promise.all(/*! import() | recupera-senha-recupera-senha-module */[__webpack_require__.e("common"), __webpack_require__.e("recupera-senha-recupera-senha-module")]).then(__webpack_require__.bind(null, /*! ./recupera-senha/recupera-senha.module */ "4hLP")).then(m => m.RecuperaSenhaPageModule)
    },
    {
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | cadastro-usuario-cadastro-usuario-module */[__webpack_require__.e("common"), __webpack_require__.e("cadastro-usuario-cadastro-usuario-module")]).then(__webpack_require__.bind(null, /*! ./cadastro-usuario/cadastro-usuario.module */ "p9h1")).then(m => m.CadastroUsuarioPageModule)
    },
    {
        path: 'fazer-denuncia',
    ...
    {
        path: 'visao-geral',
        loadChildren: () => Promise.all(/*! import() | visao-geral-visao-geral-module */[__webpack_require__.e("common"), __webpack_require__.e("visao-geral-visao-geral-module")]).then(__webpack_require__.bind(null, /*! ./visao-geral/visao-geral.module */ "PpZ/")).then(m => m.VisaoGeralPageModule)
    },
    {
        path: 'usuarios-cadastrados',
        loadChildren: () => Promise.all(/*! import() | usuarios-cadastrados-usuarios-cadastrados-module */[__webpack_require__.e("common"), __webpack_require__.e("usuarios-cadastrados-usuarios-cadastrados-module")]).then(__webpack_require__.bind(null, /*! ./usuarios-cadastrados/usuarios-cadastrados.module */ "BPnC")).then(m => m.UsuariosCadastradosPageModule)
    },
    {
        path: 'colabore-dashboard-admin',
        loadChildren: () => __webpack_require__.e(/*! import() | colabore-dashboard-admin-colabore-dashboard-admin-module */ "colabore-dashboard-admin-colabore-dashboard-admin-module").then(__webpack_require__.bind(null, /*! ./colabore-dashboard-admin/colabore-dashboard-admin.module */ "TUxc")).then(m => m.ColaboreDashboardAdminPageModule)
    },
    {
        path: 'nosso-mandato-dashboard-admin',
        loadChildren: () => __webpack_require__.e(/*! import() | nosso-mandato-dashboard-admin-nosso-mandato-dashboard-admin-module */ "nosso-mandato-dashboard-admin-nosso-mandato-dashboard-admin-module").then(__webpack_require__.bind(null, /*! ./nosso-mandato-dashboard-admin/nosso-mandato-dashboard-admin.module */ "lkx+")).then(m => m.NossoMandatoDashboardAdminPageModule)
    },
    {
        path: 'quem-sou-dashboard-admin',
        loadChildren: () => Promise.all(/*! import() | quem-sou-dashboard-admin-quem-sou-dashboard-admin-module */[__webpack_require__.e("common"), __webpack_require__.e("quem-sou-dashboard-admin-quem-sou-dashboard-admin-module")]).then(__webpack_require__.bind(null, /*! ./quem-sou-dashboard-admin/quem-sou-dashboard-admin.module */ "I074")).then(m => m.QuemSouDashboardAdminPageModule)
    },
];
